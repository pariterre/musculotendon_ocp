...
def test_force_passive_hill_type():
    ...
    assert force_passive_model(0) == -0.018633616376331333
    assert force_passive_model(normalized_muscle_length=0.5) == -0.01799177781427948
    assert force_passive_model(normalized_muscle_length=1.0) == 0.000000000000000
    assert force_passive_model(normalized_muscle_length=1.5) == 0.5043387668755398
...
def test_force_passive_always_positive_hill_type():
    ...
    # Test exact values
    assert force_passive_model(normalized_muscle_length=0.0) == 0.0
    assert force_passive_model(normalized_muscle_length=0.5) == -0.01799177781427948 - offset
    assert force_passive_model(normalized_muscle_length=1.0) == 0.000000000000000 - offset
    assert force_passive_model(normalized_muscle_length=1.5) == 0.5043387668755398 - offset
