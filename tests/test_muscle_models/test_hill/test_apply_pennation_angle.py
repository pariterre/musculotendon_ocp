...
def test_apply_pennation_angle_constant():
    ...
    # Test exact values
    assert pennation_angle_model(1.1, 1.0) == 0.9950041652780258
    assert pennation_angle_model(1.1, 0.5) == 0.4975020826390129
    assert pennation_angle_model(1.1, 0.0) == 0.0
    assert pennation_angle_model(1.1, -0.5) == -0.4975020826390129
    assert pennation_angle_model(1.1, -1.0) == -0.9950041652780258

    assert pennation_angle_model(1.2, 1.0) == 0.9950041652780258
    assert pennation_angle_model(1.2, 0.5) == 0.4975020826390129
    assert pennation_angle_model(1.2, 0.0) == 0.0
    assert pennation_angle_model(1.2, -0.5) == -0.4975020826390129
    assert pennation_angle_model(1.2, -1.0) == -0.9950041652780258
...
def test_apply_pennation_angle_wrt_muscle_fiber_length():
    ...
    assert pennation_angle_model(1.2, 1.0) == 0.9958037930046592
    assert pennation_angle_model(1.2, 0.5) == 0.4979018965023296
    assert pennation_angle_model(1.2, 0.0) == 0.0
    assert pennation_angle_model(1.2, -0.5) == -0.4979018965023296
    assert pennation_angle_model(1.2, -1.0) == -0.9958037930046592
