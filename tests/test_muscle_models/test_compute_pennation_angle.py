...
def test_compute_pennation_angle_wrt_muscle_fiber_length():
    ...
    assert pennation_angle_model(1.1) * 0.5 == ComputePennationAngleConstant(pennation_angle=0.1)(1.1) * 0.5
    assert pennation_angle_model(1.2) * 0.5 != ComputePennationAngleConstant(pennation_angle=0.1)(1.2) * 0.5
